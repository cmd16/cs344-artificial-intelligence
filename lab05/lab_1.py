...
'''
elimination_ask gets the same result, but gibbs_ask does not. That is because it is sampling to get 
an approximate answer rather than analytically computing the exact answer
'''
