...
def main():
    ...
    start_b = problem['start_b']
    finish_b = problem['finish_b']
    ops = problem['ops']
    print("Solving problem a")
    actionSequence_a = gps(start_a, finish_a, ops)
    if actionSequence_a is None:
        print("plan failure...")
        #return
    else:
        for action in actionSequence_a:
            print(action)
    print("Solving problem b")
    actionSequence_b = gps(start_b, finish_b, ops)
    if actionSequence_b is None:
        print("plan failure...")
        #return
    else:
        for action in actionSequence_b:
            print(action)
